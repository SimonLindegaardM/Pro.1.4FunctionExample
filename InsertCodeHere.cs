...
namespace FunctionExample
{
    public class InsertCodeHere
    {
        public void MyCode()
        {
            ...
            double area3 = AreaOfRectangle(rect1x1, rect1y1, rect1x2, rect1y2);
            Console.WriteLine($"Area of first rectangle is {area3}");
            ...
            double area4 = AreaOfRectangle(rect2x1, rect2y1, rect2x2, rect2y2);
            Console.WriteLine($"Area of second rectangle is {area4}");
        ...
        public double AreaOfRectangle(double x1, double y1, double x2, double y2)
        {
            ...
            double results = Math.Abs((x1-x2)*(y1-y2));            
